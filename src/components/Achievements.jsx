                    ...
                    <div className="frontside">
                      <div className="card">
                        <div className="card-body text-center">
                          <p><img className=" img-fluid" src={Photo} alt="lokana" /></p>
                          <h4 className="card-title">RDC 2023</h4>
                          <p className="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, molestiae?</p>
                  ...
                  <div className="mainflip">
                    <div className="frontside">
                      <div className="card">
                        <div className="card-body text-center">
                          <p><img className=" img-fluid" src={Photo} alt="lokana" /></p>
                          <h4 className="card-title">RDC 2021</h4>
                          <p className="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, molestiae?</p>
