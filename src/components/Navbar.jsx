...
const Navbar = () => {
  return (
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light lokanathnavbar">
        <a className="navbar-brand text-dark font-weight-bold " href="/">GCEK NAVAL <span id="lokanathblue">NCC</span></a>
